...
![OMA Studio new chat page](docs/images/new-chat-page.png)
...
![OMA Studio autopilots page](docs/images/autopilots-page.png)

Schedule an Agent instruction, filter the list, toggle it on or off, run it immediately, inspect run history, and open the linked Chat session. See the live [Autopilots page](https://studio.ohmyagent.ai/autopilots).

### Market

![OMA Studio Market page](docs/images/market-page.png)

Browse discovered Skills, Extensions, and MCP Servers from the workspace. Skills can be searched and installed from skills.sh; uninstall is intentionally deferred. See the live [Market page](https://studio.ohmyagent.ai/market).

### Library

![OMA Studio Library page](docs/images/library-page.png)

Search, filter, preview, download, and open files generated by Agents. See the live [Library page](https://studio.ohmyagent.ai/library).

### Chat detail

![OMA Studio chat detail page](docs/images/chat-detail-page.png)

Chat detail keeps the conversation history visible, supports Markdown and tool activity, provides generated files, and lets users edit the session title from the fixed header. The screenshot uses a representative local session; the requested production session is available at [`/chat/264e2f2d-2295-4e79-a975-f14f11ba2731`](https://studio.ohmyagent.ai/chat/264e2f2d-2295-4e79-a975-f14f11ba2731).
