...
| `GET /api/share/{token}/files/view?path=` | Open a supported shared HTML, image, or PDF file inline; generated HTML/SVG is sandboxed |
...
| `GET /api/chats/{id}/files/view` | Open an authorized supported HTML, image, or PDF file inline; generated HTML/SVG is sandboxed |
